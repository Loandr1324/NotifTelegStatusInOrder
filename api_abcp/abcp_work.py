...
class WorkABCP:
    ...
    async def get_order_by_status(self, status, date_updated_start=None, date_updated_end=None):
        """
        ...
        try:
            ...
            orders = await self.api_abcp.cp.admin.orders.get_orders_list(
                status_code=status, date_updated_start=date_updated_start, date_updated_end=date_updated_end, format='p'
            )
